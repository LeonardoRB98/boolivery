...
@section('content')
    <div id="stephanie-2">
        <div class="curved upper">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 319">
                <path fill="#ED4521" fill-opacity="1" d="M0,224L80,208C160,192,320,160,480,154.7C640,149,800,171,960,165.3C1120,160,1280,128,1360,112L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
            </svg>
        </div>
        <div class="curved">
            <div class="container">
                Non usate questa parte, quella sotto funziona come prima!
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 319">
                <path fill="#fff" fill-opacity="1" d="M0,224L80,208C160,192,320,160,480,154.7C640,149,800,171,960,165.3C1120,160,1280,128,1360,112L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
            </svg>
        </div>
        <section class="one">
            <div class="box">
    ...
    <div class="container text-center">
        ...
        @if (!is_null($restaurant->photo))
            <img style="width: 200px" class="img-fluid" src="{{ asset('storage/' . $restaurant->photo) }}"
                alt="{{ $restaurant->name }}">
        @else
        ...
        @if (!is_null($restaurant->photo_jumbo))
            <img style="width: 200px" class="img-fluid" src="{{ asset('storage/' . $restaurant->photo_jumbo) }}"
                alt="{{ $restaurant->name }}">
        @else
            <img style="width: 200px" class="img-fluid" src="{{ asset('image/download.png') }}"
                alt="{{ $restaurant->name }}">
        ...
        <div class="container">
            ...
            <div class="clearfix mb-4">
                <a href="{{ route('admin.plates.createPlate', ['restaurant_id' => $restaurant->id]) }}"
                    class="btn btn-primary float-right">Crea Piatto</a>
            </div>
